...
(() => {
   ...
   tape('index address, where outliers are present', (t) => {
      let address = indexdocs.standardize({
         "type":"Feature",
         "properties":{
            ...
            "carmen:lfromhn":[[740,146,null,null,null],null],
            "carmen:ltohn":[[0,10000,null,null,null],null],
            "carmen:parityr":[["O","O",null,null,null],null],
            "carmen:rfromhn":[[753,10001,null,null,null],null],
            "carmen:rtohn":[[1,9,null,null,null],null],
    ...
    tape('index address, where outliers are not present', (t) => {
      let address = indexdocs.standardize({
         ...
         "properties":{
            ...
            "carmen:center":[0,0],
            "carmen:rangetype":"tiger",
            "carmen:parityl":[[1, 2,null,null],null],
            "carmen:lfromhn":[[740,146,null,null],null],
            "carmen:ltohn":[[0,10000,null,null],null],
            "carmen:parityr":[["O","O",null,null],null],
            "carmen:rfromhn":[[753,10001,null,null],null],
            "carmen:rtohn":[[1,9,null,null,null],null],
