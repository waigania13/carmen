...
var conf = {
    country: new mem({ maxzoom: 6, languages: ['en'] }, function() {}),
    region: new mem({ maxzoom: 6, languages: ['en'] }, function() {}),
    place: new mem({ maxzoom: 6, languages: ['en'], geocoder_inherit_score: true }, function() {})
};
