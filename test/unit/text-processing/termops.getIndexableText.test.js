...
test('termops.getIndexableText', (t) => {
    ...
    texts = [
        { languages: ['default'], tokens: ['main', 'street'], hash: 248 }
    ];
    ...
    doc = { properties: { 'carmen:text': 'Main Street' } };
    texts = [
        { languages: ['default'], tokens: ['main', 'st'], hash: 248 },
    ];
    ...
    texts = [
        { languages: ['default'], tokens: ['main', 'st', 'ln'], hash: 255 },
    ];
    ...
    texts = [
        { languages: ['default'], tokens: ['main', 'st', 'st', 'ln'], hash: 13 },
    ];
    ...
    texts = [
        { languages: ['default'], tokens: ['aepfelstruedeln', 'strasse'], hash: 73 },
        { languages: ['default'], tokens: ['aepfelstrudeln', 'strasse'], hash: 73 },
        { languages: ['default'], tokens: ['apfelstruedeln', 'strasse'], hash: 73 },
        { languages: ['default'], tokens: ['apfelstrudeln', 'strasse'], hash: 73 }
    ];
    ...
    texts = [
        { languages: ['default'], tokens: ['avenue', 'du', '18e', 'regiment'], hash: 139 },
        { languages: ['default'], tokens: ['avenue', 'du', 'dix', 'huitieme', 'regiment'], hash: 139 }
    ];
    ...
    texts = [
        { languages: ['default'], tokens: ['main', 'street'], hash: 248 },
        { languages: ['default'], tokens: ['2##', 'main', 'street'], hash: 248 },
        { languages: ['default'], tokens: ['1##', 'main', 'street'], hash: 248 },
        { languages: ['default'], tokens: ['##', 'main', 'street'], hash: 248 },
        { languages: ['default'], tokens: ['#', 'main', 'street'], hash: 248 }
    ];
    ...
    texts = [
        { tokens: ['main', 'st'],            languages: ['default'], hash: 248 },
        { tokens: ['2##', 'main', 'st'],     languages: ['default'], hash: 248 },
        { tokens: ['1##', 'main', 'st'],     languages: ['default'], hash: 248 },
        { tokens: ['##', 'main', 'st'],      languages: ['default'], hash: 248 },
        { tokens: ['#', 'main', 'st'],       languages: ['default'], hash: 248 }
    ];
    t.deepEqual(termops.getIndexableText(replacers.simple, replacers.complex, [],  doc), texts, 'with range');
    ...
    texts = [
        { tokens: ['n', 'newtown', 'st', 'rd'], languages: ['default'], hash: 28 },
    ];
    ...
    texts = [
        { tokens: ['n', 'newtown', 'sq', 'st', 'rd'], languages: ['default'], hash: 190 }
    ];
    ...
    texts = [
        { languages: ['default'], tokens: ['main', 'street'], hash: 248 },
        { languages: ['es'], tokens: ['el', 'main', 'street'], hash: 19 }
    ];
    ...
    texts = [
        { languages: ['default'], tokens: ['san', 'francisco', 'airport'], hash: 59 },
        { languages: ['all'], tokens: ['sfo'], hash: 90 }
    ];
    ...
    texts = [
        { languages: ['default'], tokens: ['san', 'francisco', 'airport'], hash: 59 },
        { languages: ['all'], tokens: ['sfo'], hash: 90 },
        { languages: ['es'], tokens: ['aeropuerto', 'de', 'san', 'francisco'], hash: 201 }
    ];
    ...
    texts = [
        { languages: ['default'], tokens: ['latveria'], hash: 184 },
        { languages: ['default'], tokens: ['republic', 'of', 'latveria'], hash: 36 }
    ];
    ...
    texts = [
        { languages: ['default', 'en'], tokens: ['new', 'york'], hash: 142 },
        { languages: ['es'], tokens: ['nueva', 'york'], hash: 45 }
    ];
    ...
    texts = [
        { languages: ['default'], tokens: ['united', 'states'], hash: 91 },
        { languages: ['sv', 'all'], tokens: ['usa'], hash: 214 }
    ];
    ...
    texts = [
        { tokens: ['new', 'york'], languages: ['default', 'en'], hash: 142 },
        { tokens: ['nyc'], languages: ['default', 'en'], hash: 146 },
        { tokens: ['bakery'], languages: ['all'], hash: 250 },
        { tokens: ['nueva', 'york'], languages: ['es'], hash: 45 }
    ];
    ...
    texts = [
        { tokens: ['bakery'], languages: ['default', 'en'], hash: 250 },
        { tokens: ['new', 'york'], languages: ['default', 'en'], hash: 142 }
    ];
    ...
    texts = [
        { languages: ['default'], tokens: ['new', 'york'], hash: 142 },
        { languages: ['es'], tokens: ['nueva', 'york'], hash: 45 },
        { languages: ['en'], tokens: ['the', 'big', 'apple'], hash: 230 },
    ];
    ...
    texts = [
        { tokens: ['main', 'st', 'nw'], languages: ['default'], hash: 117 },
        { tokens: ['+intersection', 'o', 'st', 'nw', ',', 'main', 'st', 'nw'], languages: ['default'], hash: 117 }
    ];
...
test('replacer/globalReplacer interaction', (t) => {
    ...
    t.deepEqual(withOe, [
        { tokens: ['phoenix', 'str'], languages: ['default'], hash: 155 },
        { tokens: ['phonix', 'str'], languages: ['default'], hash: 155 },
    ], 'all variants are generated');
    t.deepEqual(withUmlaut, [
        { tokens: ['phoenix', 'str'], languages: ['default'], hash: 55 },
        { tokens: ['phonix', 'str'], languages: ['default'], hash: 55 },
    ], 'all variants are generated');
...
test('Reserved words for inherited functions', (t) => {
    ...
    const texts = [
        { languages: ['default'], tokens: ['constructor'], hash: 209 }
    ];
    t.deepEqual(termops.getIndexableText(replacers.simple, replacers.complex, [], doc), texts, 'creates indexableText');
    t.end();
});
