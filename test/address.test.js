...
test('address.reverse', function(assert) {
    ...
    ), { geometry: { coordinates: [ -77.03195235604245, 38.913917262468 ], type: 'Point' }, id: 75018674165319, properties: { abbrname: '14th St NW', 'carmen:center': [ -77.031953, 38.919952 ], 'carmen:extid': 'addressitp.75018674165319', 'carmen:lfromhn': [ '1618', '2750', '3000', '3022', '2900', '1700', '1624', '', '1600', '2300', '2800', '2512', '2400', '2000', '1924', '1800', '1820', '2450', '2100', '2524', '2500', '1900', '2700', '2200', '', '1720', '2600' ], 'carmen:ltohn': [ '1620', '2798', '3020', '3098', '2998', '1718', '1698', '', '1616', '2398', '2898', '2522', '2448', '2098', '1998', '1818', '1898', '2498', '2198', '2598', '2510', '1922', '2748', '2298', '', '1798', '2698' ], 'carmen:parityl': [ 'E', 'E', 'E', 'E', 'E', 'E', 'E', '', 'E', 'E', 'E', 'E', 'E', 'E', 'E', 'E', 'E', 'E', 'E', 'E', 'E', 'E', 'E', 'E', '', 'E', 'E' ], 'carmen:parityr': [ 'O', 'O', 'O', 'O', 'O', 'O', '', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O' ], 'carmen:rangetype': 'tiger', 'carmen:rfromhn': [ '1623', '2701', '3001', '3033', '2851', '1701', '', '2751', '1601', '2301', '2801', '2501', '2351', '2001', '1921', '1801', '1825', '2401', '2101', '2511', '2427', '1901', '2651', '2201', '2565', '1721', '2601' ], 'carmen:rtohn': [ '1699', '2749', '3031', '3099', '2999', '1719', '', '2799', '1621', '2349', '2849', '2509', '2399', '2099', '1999', '1823', '1899', '2425', '2199', '2563', '2499', '1919', '2699', '2299', '2599', '1799', '2649' ], 'carmen:text': '14th St NW', 'carmen:tmpid': 323909959, 'carmen:zxy': [ '14/4686/6266', '14/4686/6265' ] } });
    assert.end();
});
...
test('address.getReversePoint', function(assert) {
    ...
    assert.deepEqual(
        ...
        { endLine: { geometry: { coordinates: [ -77.19883829355238, 38.94759461125006 ], type: 'Point' }, properties: {}, type: 'Feature' }, lineDist: 0.061529042258824385, pt: { geometry: { coordinates: [ -77.1993203839748, 38.94757788892784 ], type: 'Point' }, properties: { dist: 0.00866597311017573, index: 0, travelled: 0.03556894162976693 }, type: 'Feature' }, startLine: { geometry: { coordinates: [ -77.19998091459274, 38.9475549770314 ], type: 'Point' }, properties: {}, type: 'Feature' } },
    ...
    assert.deepEqual(
        ...
        { endLine: { geometry: { coordinates: [ -77.19883829355238, 38.94759461125006 ], type: 'Point' }, properties: {}, type: 'Feature' }, lineDist: 0.061529042258824385, pt: { geometry: { coordinates: [ -77.19951739103843, 38.947571055322676 ], type: 'Point' }, properties: { dist: 0.010508440821625104, index: 0, travelled: 0.02496030099528378 }, type: 'Feature' }, startLine: { geometry: { coordinates: [ -77.19998091459274, 38.9475549770314 ], type: 'Point' }, properties: {}, type: 'Feature' } },
    ...
    assert.deepEqual(
        ...
        { endLine: { geometry: { coordinates: [ -77.19883829355238, 38.94759461125006 ], type: 'Point' }, properties: {}, type: 'Feature' }, lineDist: 0.061529042258824385, pt: { geometry: { coordinates: [ -77.19998091459274, 38.9475549770314 ], type: 'Point' }, properties: { dist: 0.03244781364955206, index: 0, travelled: 0 }, type: 'Feature' }, startLine: { geometry: { coordinates: [ -77.19998091459274, 38.9475549770314 ], type: 'Point' }, properties: {}, type: 'Feature' } },
    ...
    assert.deepEqual(
        ...
        { endLine: { geometry: { coordinates: [ -77.19883829355238, 38.94759461125006 ], type: 'Point' }, properties: {}, type: 'Feature' }, lineDist: 0.061529042258824385, pt: { geometry: { coordinates: [ -77.19883829355238, 38.94759461125006 ], type: 'Point' }, properties: { dist: 0.013851925203832237, index: 0, travelled: 0.061529042258824385 }, type: 'Feature' }, startLine: { geometry: { coordinates: [ -77.19998091459274, 38.9475549770314 ], type: 'Point' }, properties: {}, type: 'Feature' } },
        "after end of line");
