...
test('reverse address point clustering', function(t) {
    t.deepEqual(
        addressCluster.reverse(
            ...
            { _address: '9', _cluster: { 10: { coordinates: [ 2, 4 ], type: 'Point' }, 7: { coordinates: [ 0, 1 ], type: 'Point' }, 9: { coordinates: [ 1, 3 ], type: 'Point' } }, _geometry: { coordinates: [ 1, 3 ], type: 'Point' }, _text: 'test' });
    t.end();
});
