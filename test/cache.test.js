...
test('Cache', function(t) {
    t.test('cache unit', function(q) {
        q.test('class functions', function(r) {
            r.test('.shard', function(s) {
        ...
        q.test('c++ functions', function(r) {
            r.test('#list', function(s) {
                var cache = new Cache('a', 1);
                cache.set('term', 5, [0,1,2]);
            ...
            r.test('#unload on empty data', function(s) {
                var cache = new Cache('a', 1);
            ...
            r.test('#unload after set', function(s) {
                var cache = new Cache('a', 1);
            ...
            r.test('#unload after load', function(s) {
                var cache = new Cache('a', 1);
                var array = [];
                for (var i=0;i<10000;++i) {
                    array.push(0);
