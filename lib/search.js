...
// # Search
//
// @param {Object} source a Carmen datasource
...
module.exports = function search(source, query, id, callback) {
    ...
    function getDegen(queue, result, idx, callback) {
        ...
        source._geocoder.getall(source.getCarmen.bind(source), 'degen', [queue[idx]], mapTerms);
    ...
    function getPhrases(queue, callback) {
        ...
        source._geocoder.getall(source.getCarmen.bind(source), 'term', queue, function(err, result) {
            if (err) return callback(err);
    ...
    function getTerms(queue, callback) {
        ...
        source._geocoder.getall(source.getCarmen.bind(source), 'phrase', queue, function(err, result) {
            if (err) return callback(err);
    ...
    function getFreqs(queue, callback) {
        queue.unshift(0);
        var total;
        source._geocoder.getall(source.getCarmen.bind(source), 'freq', queue, function(err) {
            if (err) return callback(err);
    ...
    function getgrids(queue, callback) {
        ...
        source._geocoder.getall(source.getCarmen.bind(source), 'grid', queue, function(err) {
            if (err) return callback(err);
