...
function crossStreets(features) {
    // combines 2+ features into one feature, w/ intersection?
        // don't seem to have right data (only center), so get features by id
            // verify possible intersection (handle more than one intersection?)
            // calculate intersection
            // represent intersection in feature
    ...
    console.log('flat feature:', JSON.stringify(combinedFeature, null, 2));
