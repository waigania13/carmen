                ...
                if (options.types) {
                    ...
                    for (var type_it = 0; type_it < options.types.length; type_it++) {
                        ...
                        if (type[1] && loadedSource.scoreranges && Object.keys(loadedSource.scoreranges).indexOf(type[1] > -1)) {
                            var range = loadedSource.scoreranges[type[1]];
                            range[0] = loadedSource.maxscore * range[0];
                            range[1] = loadedSource.minscore * range[1];
                            console.error(loadedSource.minscore, loadedSource.maxscore)
                        }
                    }
...
function dropFeature(geocoder, options, results, callback) {
    ...
    for (var i = 0; i < results.length; i++) {
        ...
        function typeMatch() {
            ...
            var pass = false;
            subtypes = source.scoreranges ? Object.keys(source.scoreranges) : [];
