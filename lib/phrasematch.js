    ...
    while (l--) {
        ...
        if (text) {
            ...
            if (!tryNormalization) {
                ...
                if (!subquery.ender) {
                    if (dawgMatch.variants) variants = dawgMatch.normalizations.length ? [{text: dawgMatch.normalizations[0], ender: subquery.ender}] : [{text: subquery.join(' '), ender: subquery.ender}];
                } else {
                    variants = [{text: subquery.join(' '), ender: subquery.ender}];
