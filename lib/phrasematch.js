...
module.exports = function phrasematch(source, query, disableAutocomplete, callback) {
    ...
    for (var l = 0; l < subqueries.length; l++) {
        var phrase = termops.encodePhrase(subqueries[l], disableAutocomplete ? false : subqueries[l].ender);
