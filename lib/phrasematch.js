...
module.exports = function phrasematch(source, query, options, callback) {
    ...
    if (options.bbox) {
        ...
        if (!intersects) return callback(null, new PhrasematchResult([], getter, source));
    }
    ...
    return callback(null, new PhrasematchResult(phrasematches, getter, source));
};

module.exports.PhrasematchResult = PhrasematchResult;
function PhrasematchResult(phrasematches, getter, source) {
