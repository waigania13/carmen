    ...
    while (l--) {
        ...
        if (text) {
            ...
            languages = languages.map(function(l) {
                // probably don't want to fall back to default here either
                return source.lang.lang_map.hasOwnProperty(l) ? source.lang.lang_map[l] : source.lang.lang_map['default'];
            });
