...
function loadFeature(source, feat, full, query, language, callback) {
    ...
    if (!full) {
        ...
        if (properties['carmen:center']) {
            ...
            if (Array.isArray(properties['carmen:center'])) {
                loaded.properties['carmen:center'] = properties['carmen:center'];
            } else {
