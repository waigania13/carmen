...
module.exports = function(geocoder, query, options, callback) {
    ...
    // Forward geocode.
    return forwardGeocode(geocoder, tokenized, options, callback);
};
...
function forwardGeocode(geocoder, tokenized, options, callback) {
    ...
    for (var dbid in geocoder.indexes) q.defer(phrasematch, geocoder.indexes[dbid], queryData.query.join(' '));
    q.awaitAll(function(err, results) {
        ...
        zooms = uniq(zooms).sort(sortNumeric);
