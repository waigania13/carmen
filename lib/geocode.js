...
module.exports = function(geocoder, query, options, callback) {
    ...
    if (options.proximity) {
        if (options.proximity.length !== 2) {
            if (( typeof options.proximity !== "string" && options.proximity.length !== 2) || ( typeof options.proximity === "string" && options.proximity.indexOf(',') === -1))
                ...
                options.proximity = [options.proximity.split(',')[0].trim(), options.proximity.split(',')[1].trim()];
        }
