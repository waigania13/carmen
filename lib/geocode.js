    ...
    if (options.types) {
        ...
        while (l--) {
            if (!geocoder.bytype[options.types[l]] && !geocoder.bysubtype[options.types[l]]) {
                ...
                var subtypeAndTypeExist = geocoder.bytype[options.types[l]] && (options.types.indexOf(options.types[l]) != l);
                var subtypeIndexWhenTypeExists = subtypeAndTypeExist ? options.types.indexOf(options.types[l]) : -1;
