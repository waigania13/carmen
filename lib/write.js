// # Write
//
// Utilities for serializing, storing, and writing indexes to tilelive
// sources.

// ## Store
//
// Serialize and make permanent the index currently in memory for a source.
module.exports.store = function(source, callback) {
    var queue = [];
...
module.exports.index = function(source, docs, callback) {
