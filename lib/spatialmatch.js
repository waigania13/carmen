...
function spatialmatch(indexes, types, query, stats, geocoder, feats, grids, zooms, proximity, callback) {
    ...
    for (c in coalesced) {
        ...
        // Only use the reversed setRelevance if it's larger.
        // In equal/tie situations the forward order should be used
        // as it prioritizes first indexes over latter ones.
