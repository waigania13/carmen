        ...
        coalesce(stack, coalesceOpts, function(err, features) {
            ...
            while (l--) {
                ...
                while (m--) {
                    ...
                    feature[m].score = feature[m].score !== 0 ? Math.pow(byIdx[feature[m].idx].scorefactor, feature[m].score/7) : 0;
                    feature[m].scoredist = Math.pow(byIdx[feature[m].idx].scorefactor, feature[m].scorefactor/7);
                    console.log("Score", feature[m].score)
                }
            }
