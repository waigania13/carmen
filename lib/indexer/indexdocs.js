        ...
        if (docs[i].properties['carmen:rangetype']) {
            for (var c_it = 0; c_it < docs[i].geometry.geometries.length; c_it++) {
                ...
                for (var addr_it = 0; addr_it < docs[i].geometry.geometries[c_it].coordinates.length; addr_it++) {
                    var feat = JSON.parse(JSON.stringify(docs[i]));
                    if (feat.properties['carmen:parityl']) feat.properties['carmen:parityl'] = [feat.properties['carmen:parityl'][c_it][addr_it]]
                    if (feat.properties['carmen:parityr']) feat.properties['carmen:parityr'] = [feat.properties['carmen:parityr'][c_it][addr_it]]
                    if (feat.properties['carmen:lfromhn']) feat.properties['carmen:lfromhn'] = [feat.properties['carmen:lfromhn'][c_it][addr_it]]
                    if (feat.properties['carmen:rfromhn']) feat.properties['carmen:rfromhn'] = [feat.properties['carmen:rfromhn'][c_it][addr_it]]
                    if (feat.properties['carmen:ltohn']) feat.properties['carmen:ltohn'] = [feat.properties['carmen:ltohn'][c_it][addr_it]]
                    if (feat.properties['carmen:rtohn']) feat.properties['carmen:rtohn'] = [feat.properties['carmen:rtohn'][c_it][addr_it]]
