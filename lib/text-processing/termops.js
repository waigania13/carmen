 ...
 * @param {object} doc
 * @param TODO defaultLanguages
 * @param TODO categories
...
function permutations(terms, weights, all) {
    ...
    for (let i = 0; i < masks.length; i++) {
        ...
        permutation.mask = mask; // TODO not reliable remove
...
* getIndexablePhrases
*
* @param {TokenizedQuery} tokenized text TODO consider just passing token array
