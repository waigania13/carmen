...
function standardize(feat){
    ...
    if (feat._rangetype !== 'tiger' ||
        ...
        feat._geometry.type !== 'MultiLineString')) return ranges;
    var stdFeat = {
    ...
    while (i--) {
        ...
        if (falsy(f.lf) && falsy(f.rf) && falsy(f.lt) && falsy(f.rt)) continue;
        ranges.push(f);
    }
    ranges.sort(function(a, b) {
        if (a.lf !== b.lf) return a.lf < b.lf ? -1 : 1;
        if (a.rf !== b.rf) return a.rf < b.rf ? -1 : 1;
        if (a.lt !== b.lt) return a.lt < b.lt ? -1 : 1;
        if (a.rt !== b.rt) return a.rt < b.rt ? -1 : 1;
        if (a.lp !== b.lp) return a.lp < b.lp ? -1 : 1;
        if (a.rp !== b.rp) return a.rp < b.rp ? -1 : 1;
        if (a.lines.length !== b.lines.length) return a.lines.length < b.lines.length ? -1 : 1;
        return 0;
    });
    return ranges;
}
