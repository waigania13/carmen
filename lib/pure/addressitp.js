...
function standardize(feat, i) {
    ...
    if (feat.properties['carmen:rangetype'] !== 'tiger' || !feat.geometry || feat.geometry.geometries[i].type !== 'MultiLineString') return ranges;

    var stdFeat = {
        lines: feat.geometry.geometries[i].coordinates,
        lf: feat.properties['carmen:lfromhn'][i],
        lt: feat.properties['carmen:ltohn'][i],
        rf: feat.properties['carmen:rfromhn'][i],
        rt: feat.properties['carmen:rtohn'][i],
        lp: feat.properties['carmen:parityl'][i],
        rp: feat.properties['carmen:parityr'][i]
    };
...
function reverse(feat,query) {
    if (feature.geometry.type !== 'GeometryCollection') return feat;
    ...
    //@TODO FIX ME I DON"T SUPPORT GEOMETRY COLLECTION - POTENTIAL IS WRONG!
