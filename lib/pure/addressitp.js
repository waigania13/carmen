...
function matchSide(feat, side, point, strict) {
    ...
    if (feat.properties[sideVar.parity] && !feat.properties[sideVar.parity][point.i] && !strict) return matchSide(feat, opp, point, true);
    if (feat.properties[sideVar.parity] && !feat.properties[sideVar.parity][point.i] && strict) return null;
