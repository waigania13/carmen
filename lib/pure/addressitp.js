...
function matchSide(feat, side, point, strict) {
    ...
    if ((!feat[sideVar.parity] || !feat[sideVar.parity][point.i]) && !strict) return matchSide(feat, opp, point, true);
    if ((!feat[sideVar.parity] || !feat[sideVar.parity][point.i]) && strict) return null;
