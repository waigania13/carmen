var Dictcache = require('./util/dictcache');
...
function MemSource(docs, info, callback) {
    ...
    this._dictcache = dictcache;
    this._shards = {};
    this._grids = {};
    this._info = info || { maxzoom: 6 };
    this._info.geocoder_version = this._info.geocoder_version !== undefined ? this._info.geocoder_version : 4;
    this.open = true;
    this.docs = docs;
