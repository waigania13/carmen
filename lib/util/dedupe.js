...
/**
 * removes duplicates in an array of features.
 * @param {array} - array of carmen-formatted features 
 */
function dedupe(features) {
    ...
    function relevSort(a, b) {
        if (a.relevance > b.relevance) return -1;
        if (a.relevance < b.relevance) return 1;
        return 0;
    };

    // use timsort module to preserve order from previous contextSort
    timsort.sort(b, relevSort);
