...
Cache.SHARD_PREFIX_LENGTH = cc.SHARD_PREFIX_LENGTH;
...
Cache.prototype.loadall = function(getter, type, ids, callback) {
    ...
    cache.loadallshards(getter, type, allshards, function(err, allshards) {
        callback(err, allshards, queues);
    })
};

Cache.prototype.loadallshards = function(getter, type, allshards, callback) {
    var cache = this;
    var shards = [];
