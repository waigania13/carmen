...
//
// * has(type, shard)
// * load(buffer, type, shard, [options], [callback])
// * loadSync(buffer, type, shard, [options], [callback])
// * loadJSON(object, type, shard)
// * search(type, shard)
...
// Store a id->data pair into this cache, computing the appropriate
// shard
...
Cache.prototype.getall = function(getter, type, ids, callback) {
    ...
    function loadshard(shard, queue, force) {
        ...
        if (!has_shard) {
            return getter(type, shard, function(err, buffer) {
