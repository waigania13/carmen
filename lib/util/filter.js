...
function featureMatchesLanguage(feature, options) {
    ...
    var label = closestLang.closestLangLabel(options.language[0], feature.properties, 'carmen:text_', options.languageMode);

    var a = closestLang.getLanguageCode(label);
    var b = closestLang.getLanguageCode(options.language[0]);
