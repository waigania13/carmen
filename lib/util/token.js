 ...
 *
 *   - The patterns are used in {@link createReplacer} to create `XRegExp`s (case-insensitive)
 ...
 *
 * This map is used on input strings at both query and index time. Some use cases:
 *
 * **Abbreviating multiple words:** PO Box
 *
