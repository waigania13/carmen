...
function getIndexableText(replacer, globalTokens, doc, hasLanguages) {
    var indexableText = {};
    ...
    // if this index has translations, we only index the default text for the 'default' language
    ...
    //
    // alternatively, if this index has no translations, there are no language-specific texts that could win
