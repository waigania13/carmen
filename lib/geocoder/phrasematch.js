...
module.exports = function phrasematch(source, query, options, callback) {
    ...
    for (const subquery of subqueries) {
        ...
        phrasematches.push(new Phrasematch(subquery, weight, subquery.mask, phrase, scorefactor, source.idx, source._geocoder.grid, source.zoom, source.geocoder_coalesce_radius, prefix, languages, editMultiplier, proxMatch, catMatch, partialNumber, extendedScan, subquery.address));
    }
 ...
 */
function Phrasematch(subquery, weight, mask, phrase, scorefactor, idx, cache, zoom, radius, prefix, languages, editMultiplier, proxMatch, catMatch, partialNumber, extendedScan, address) {
...
Phrasematch.prototype.clone = function() {
    return new Phrasematch(this.subquery.slice(), this.weight, this.mask, this.phrase, this.scorefactor, this.idx, this.cache, this.zoom, this.radius, this.prefix, this.languages, this.editMultiplier, this.proxMatch, this.catMatch, this.partialNumber, this.extendedScan, this.address);
};
