...
module.exports = function phrasematch(source, query, options, callback) {
    ...
    for (const subquery of subqueries) {
        ...
        phrasematches.push(new Phrasematch(subquery, weight, subquery.mask, phrase, scorefactor, source.idx, source._geocoder.grid, source.zoom, source.radius, prefix, languages, editMultiplier, proxMatch, catMatch, partialNumber, extendedScan, subquery.address));
    }
