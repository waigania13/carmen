...
module.exports = function phrasematch(source, query, options, callback) {
    ...
    const subqueries = source.geocoder_address ?
        getAddressSubqueries(tokenized, source, maxDistance, options) :
        getNormalSubqueries(tokenized, source, maxDistance, options);
...
function getNormalSubqueries(tokenized, source, maxDistance, options) {
...
function getAddressSubqueries(tokenized, source, maxDistance, options) {
