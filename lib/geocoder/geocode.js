...
module.exports = function(geocoder, query, options, callback) {
    ...
    if (pluscode.isValid(query)) {
        const code = pluscode.decode(query);

        return reverseGeocode(geocoder, [code.longitudeCenter, code.latitudeCenter], options, callback);
    }
