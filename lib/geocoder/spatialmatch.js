...
function spatialmatch(query, phrasematchResults, options, stats_data, callback) {
    let stacks;
    let run_times;
    ...
    function coalesceFinalize(err, results) {
        ...
        return callback(null, { results: filteredSpatialmatches, sets: sets, waste: waste }, stats_data);
    }
}
