...
function verifyContext(context, peers, strict, loose, indexes) {
    ...
    //  with geocoder_squishy_inherit enabled. When they are encountered, avoid
    ...
    if (indexes[context[0].properties['carmen:index']].geocoder_squishy_inherit)
    ...
    for (let c = 0; c < context.length; c++) {
        ...
        if (
            ...
            indexes[feat.properties['carmen:index']].geocoder_squishy_bestow
        ) {
