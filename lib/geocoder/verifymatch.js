    ...
    for (let pos = 0; pos < loaded.length; pos++) {
        ...
        for (const feat of feats) {
            ...
            feat.properties['carmen:inside_radius'] = options.proximity ?
                feat.properties['carmen:distance'] < proximity.scaleRadius(feat.properties['carmen:zoom']) :
                null;
...
function sortFeature(a, b) {
    const result = ((b.properties['carmen:relevance'] || 0) - (a.properties['carmen:relevance'] || 0)) ||
    ...
    // if we're tied on relevance and presence/absence of address, things get a little messy
    if (a.properties['carmen:inside_radius'] === b.properties['carmen:inside_radius']) {
        return ((a.geometry && a.geometry.omitted ? 1 : 0) - (b.geometry && b.geometry.omitted ? 1 : 0)) ||
        ...
        return ((b.properties['carmen:scoredist'] || 0) - (a.properties['carmen:scoredist'] || 0)) ||
...
function sortContext(a, b) {
    ...
    if (omitted !== 0 && a[0].properties['carmen:inside_radius'] === b[0].properties['carmen:inside_radius']) return omitted;
