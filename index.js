...
function Geocoder(indexes, options) {
    ...
    q.awaitAll(function(err, results) {
        ...
        if (results) results.forEach(function(data, i) {
            ...
            source.geocoder_reverse_tokens = options.geocoder_reverse_tokens||{};
            ...
            source.indexing_replacer = token.createReplacer(info.geocoder_tokens||{}, {includeUnambiguous: true, custom: source.geocoder_reverse_tokens||{}});
