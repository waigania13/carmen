...
Carmen was designed with the goal of being agnostic to how its underlying data is stored. This goal has been acheived to some degree, but there's still work to be done.
